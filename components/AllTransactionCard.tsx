...
const AllTransactionCard = () => {
  return (
    <View className="w-[190px] h-[180px] bg-[#363636] rounded-xl flex">
      <View className="h-[60%] w-full flex justify-center p-3">
        ...
        <Text className="font-pregular text-lg uppercase text-white mt-3">
          All Operation
        </Text>
      </View>
      <View className="h-[40%] w-full flex justify-end p-3">
        <Text className="font-pregular text-sm text-white opacity-70">
